...
<html lang="en">
  ...
  <body>
      ...
      <nav id="navbar"
        ...
        <div
          ...
          <button onclick="showNavbar()" type="button"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-600" width="24" height="24" viewBox="0 0 24 24"
        ...
        <ul class="space-y-2 text-slate-700">
          ...
          <li class="group flex w-full cursor-pointer items-center pl-4 pr-2">
            <a href="{{ route('admin.parentdocument.index') }}"
              ...
              <p class="pt-0.5 font-medium">Parent Dokumen</p>
            </a>
          </li>
          <li class="group flex w-full cursor-pointer items-center pl-4 pr-2">
    ...
    <div class="w-full h-full bg-black/80 top-0 absolute z-50 items-center justify-center hidden px-2"
      id="modal-layout">
      @yield('modal')
    </div>
    <script>
      ...
      function showForm() {
        ...
        } else {container.classList.replace('translate-x-0', 'translate-x-full')
          setTimeout(()=> {
